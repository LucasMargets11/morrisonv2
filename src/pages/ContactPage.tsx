...
const ContactPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="relative min-h-screen flex flex-col justify-center pt-24 pb-8">
        ...
        <div className="relative container mx-auto px-4 flex flex-1 items-center justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-5xl items-center">
            {/* Formulario primero en mobile, a la derecha en desktop */}
            ...
            {/* Cards debajo en mobile, a la izquierda en desktop */}
